      ...
      <div className="max-w-7xl mx-auto">
                          ...
                          {item.selectedUpgrade && (
                            <div className={`p-3 rounded-lg border-2 mb-3 ${
                              ...
                              <p className={`text-sm font-semibold mb-1 ${
                                ...
                                {item.selectedUpgrade.about}
                              </p>
                              {item.selectedUpgrade.Ram && item.selectedUpgrade.Storage && (
                                <p className={`text-xs ${
                              ...
                              <p className={`text-xs font-bold mt-2 ${
                                ...
                                +${item.selectedUpgrade.price.toFixed(2)}
                              </p>
                            </div>
                          )}
        ...
        {selectedProduct && (
          <CardModal
            ...
            preSelectedUpgrade={selectedProduct.selectedUpgrade}
          />
        )}
      </div>
    </div>
